...
namespace Raspberry_Pi_Trebuchet.IOT.Tests.RestUpImplementation
{
    class MutableHttpServerRequestForTests : IHttpServerRequest
    {
        private readonly List<IHttpRequestHeader> _headers;

        internal MutableHttpServerRequestForTests()
        {
        ...
        public static Task<MutableHttpServerRequestForTests> HttpRequestParser { get; private set; }
